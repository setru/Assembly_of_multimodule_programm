...
void funcright(long long int* a, int n) {               //генерация отсортированного массива
    int sign;
    for (int i = 0; i < n; i++) {
         if (i == 0) {
             a[i] = (long long int)rand() * rand() * rand();
...
void funcback(long long int* a, int n) {                //генерация массива, отсортированного в обратном порядке
    int sign;
    for (int i = 0; i < n; i++) {
         if (i == 0) {
             a[i] = (long long int)rand() * rand() * rand();
